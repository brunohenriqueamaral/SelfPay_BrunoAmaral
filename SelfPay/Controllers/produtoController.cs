...
namespace SelfPay.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public ProdutoController(SelfPayContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("produto_id,produto_nome,produto_desc,produto_ativo,produto_preco,produto_precoPromo")] Produto produto)
        {
